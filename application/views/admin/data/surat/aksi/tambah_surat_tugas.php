...
$jmlSpt = $this->Data_surat_tugas->countSpt();
$depan = '090';
$belakang = 'PD/Umum';
$tahun = date('Y');
$newNo = $depan."/".sprintf("%04s", $jmlSpt)."/".$belakang."/".$tahun;
?>
...
<section class="invoice">
    <form id="form_tambah" method="POST" action="<?= base_url() ?>index.php/admin/surat/Surat_tugas/insertSuratTugas" enctype="multipart/form-data">
        <div class="row invoice-info">
            <div class="row">
                <div class="col-sm-12 invoice-col">
                    ...
                    <div class="col-sm-9 invoice-col">
                        <label><?= $newNo; ?></label>
                        <input type="hidden" class="form-control" id='no_spt' name='no_spt' value="<?= $newNo; ?>" readonly required>
                        <input type="hidden" class="form-control" id='id_nd' name='id_nd' value="<?= $id_nd; ?>" readonly required>
                    </div>
                </div>
            </div>
            <br>
...
<!--                         <tr>
                            ...
                            <td style="border: 0px;" colspan="2">
                                <input type="text" class="form-control" name='alat_angkut' required autofocus="true">
                            ...
                            <td style="border: 0px;">
                                <select name='id_ttd' id='id_ttd' class="btn btn-default select2" style="width: 100%" required>
                                    ...
                                    foreach ($get_refTtdNotStafAhli as $grt) {
                                        echo"<option value='$grt->id' data-id='$grt->id'>$grt->nama</option>";
                                    }
                                    ?>
                                </select>
                            </td>
