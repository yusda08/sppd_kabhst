...
<section class="content">
 ...
 <td style="">
     ...
     <a onclick="return <?=$klik?>" href="<?= base_url('index.php/skpd/surat/Nota_dinas/update/'.$value->id);?> " <?= $disabled ?> class="btn btn-warning btn-block btn-flat btn-xs">
                    <i class='fa fa-search'></i>&nbsp;Verifikasi</a>
                                 </td>
