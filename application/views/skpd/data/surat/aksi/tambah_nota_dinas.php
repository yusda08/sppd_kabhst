                ...
                <div class="box-body">
                    <form id="form_tambah" method="POST" action="<?= base_url() ?>index.php/skpd/surat/Nota_dinas/insertNotaDinas" enctype="multipart/form-data">
                        ...
                        <input type = "hidden" class = "form-control" name = "info" id="info" 
                               value="<?php if($id_tujuan==1 or $id_tujuan==2 or $id_tujuan==3){
                                   echo 'luar';
                               }else{
                                   echo 'dalam';
                               }
                        ...
                        <div class="pull-right">
                            ...
                            <button type="submit"  id="add" class="btn btn-success" data-loading-text="Loading..." autocomplete="off" disabled>Simpan</button>
        ...
        <div class="modal-content">
            ...
            <from id="form_tambah">
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control id_skpd" name="id_skpd" placeholder="">
                </div>
            </from>
...
//        alert(nip+''+nama+''+jabatan+''+pangkat+''+gol);
    ...
    $('.pegawai_pns').on('change', function () {
        ...
        var kunker = $(".pegawai_pns option:selected").data('nunker');
//        alert(nip+''+nama+''+jabatan+''+pangkat+''+gol);
        $(".nip").val(nip);
        $(".id_skpd").val(kunker);
        $(".nama").val(nama);
